        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/drug-seizures" className="hover:text-white transition-colors">Drug Seizures</Link></li>
              <li><Link href="/tps" className="hover:text-white transition-colors">TPS</Link></li>
              <li><Link href="/wait-times" className="hover:text-white transition-colors">Wait Times</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <a href="https://www.spacgraveyard.com" target="_blank" rel="noopener noreferrer" className="block text-gray-500 hover:text-teal-700 text-sm transition-colors">SPACGraveyard</a>              <li><a href="https://thedataproject.ai" className="hover:text-white transition-colors">TheDataProject.ai</a></li>
            </ul>
          </div>
        </div>
