  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <p className="text-lg text-gray-600 mb-8">
        ...
        {' '}{titleCase(top5[0].name)} leads with {top5[0].cases.toLocaleString()} cases, followed by {titleCase(top5[1].name)} ({top5[1].cases.toLocaleString()}) and {titleCase(top5[2].name)} ({top5[2].cases.toLocaleString()}).
      </p>
